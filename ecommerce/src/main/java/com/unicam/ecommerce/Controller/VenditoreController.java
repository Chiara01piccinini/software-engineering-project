...
public class VenditoreController {
    ...
    public VenditoreController(Session session, Gestore gestore, Marketplace sistema, PersistenceManager persistenceManager) {
    ...
    public ResponseEntity<String> richiediInformazioni(@RequestBody RichiestaInformazioni richiesta) throws IOException {
        if (!session.isAuthenticated()) {
            return ResponseEntity.status(403).body("Devi essere loggato per fare richieste.");
        }
    ...
    public ResponseEntity<String> attivaVendita(@RequestBody Map<String, Object> body) throws IOException {
        ...
        if(attivata) {
            ...
            return ResponseEntity.ok("Vendita attivata per il prodotto: " + prodotto.getNome());
        } else {
            return ResponseEntity.badRequest().body("Prezzo non valido o prodotto nullo.");
        }
    }
    ...
    public ResponseEntity<String> richiediSponsorizzazione(@RequestBody RichiestaSponsorizzazione richiesta) throws IOException {
