...
public class Trasformatore extends Venditore {
     ...
     */
    @JsonCreator
    public Trasformatore(@JsonProperty("tipo") TipoAccount tipo,@JsonProperty("nome")String nome,@JsonProperty("cognome") String cognome,@JsonProperty("azienda") Azienda azienda) {
