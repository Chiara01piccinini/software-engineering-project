...
public class Produttore extends Venditore {
     ...
     */
    @JsonCreator
    public Produttore(@JsonProperty("tipo") TipoAccount tipo,@JsonProperty("nome")String nome,@JsonProperty("cognome") String cognome,@JsonProperty("azienda") Azienda azienda) {
