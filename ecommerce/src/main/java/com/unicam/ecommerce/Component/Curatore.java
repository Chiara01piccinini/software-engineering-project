...
public class Curatore extends Componente {
    ...
    private final List<Richiesta> richiestePendenti = new ArrayList<>();
     ...
     */
    public void approvaProdotto(RichiestaProdotto richiesta, Gestore gestore) {
     ...
     */
    public void approvaPacchetto(RichiestaPacchetto richiesta, Gestore gestore) {
     ...
     */
    public void approvaEvento(RichiestaEvento richiesta, Gestore gestore) {
        if (richiesta.getNome() != null &&
     ...
     */
    public void approvaRichiestaInformazioni(RichiestaInformazioni richiesta, Gestore gestore) {
        richiestePendenti.remove(richiesta);
